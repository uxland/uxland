...
describe('app geo location selectors', () =>{
    ...
    describe('geo location selector', () =>{
        describe('When invoking geoLocationSelector', () =>{
            ...
            describe('and state geo location is undefined', () =>{
                it('should return null', () =>{
                    expect(selectors.geoLocationSelector(<any>{app:{geoLocation: undefined}})).toBeUndefined();
                });
            });
            describe('and geo location is set', () =>{
                it('should return state app geo location', () =>{
                    ...
                    expect(selectors.geoLocationSelector(<any>{app: {geoLocation: geoLocationState2}})).toBe(geoLocationState2);
                });
            });
        });
    });
    describe('last known position selector', () =>{
        describe('When invoking lastKnownPositionSelector', () =>{
            ...
            describe('and state geo location is null', () =>{
                it('should return undefined', () =>{
                    expect(selectors.lastKnownPositionSelector(<any>{app:{geoLocation: null}})).toBeUndefined();
                });
            });
            describe('and state geo location is undefined', () =>{
                it('should return null', () =>{
                    expect(selectors.lastKnownPositionSelector(<any>{app:{geoLocation: undefined}})).toBeUndefined();
                });
            });
            describe('and state last known position is null', () =>{
                it('should return null', () =>{
                    expect(selectors.lastKnownPositionSelector(<any>{app:{geoLocation: {lastKnownPosition: null}}})).toBeNull();
                })
            });
            describe('and state last known position is undefined', () =>{
                it('should return undefined', () =>{
                    expect(selectors.lastKnownPositionSelector(<any>{app:{geoLocation: {lastKnownPosition: undefined}}})).toBeUndefined();
                })
            });
            describe('and state last known position is set', () =>{
                it('should return state last known position', () =>{
                    ...
                    expect(selectors.lastKnownPositionSelector(<any>{app: {geoLocation: {lastKnownPosition: position}}})).toBe(position);
                    ...
                    expect(selectors.lastKnownPositionSelector(<any>{app: {geoLocation: {lastKnownPosition: otherPosition}}})).toBe(otherPosition);
                })
            });
        });
    });
    describe('registered watchers selectors', () =>{
        describe('When invoking registeredWatchersSelector', () =>{
            ...
            describe('and state geo location is null', () =>{
                it('should return undefined', () =>{
                    expect(selectors.registeredWatchersSelector(<any>{app:{geoLocation: null}})).toBeUndefined();
                });
            });
           describe('and state geo location is undefined', () =>{
                it('should return null', () =>{
                    expect(selectors.registeredWatchersSelector(<any>{app:{geoLocation: undefined}})).toBeUndefined();
                });
            });
             describe('and state registered watchers is null', () =>{
                it('should return null', () =>{
                    expect(selectors.registeredWatchersSelector(<any>{app:{geoLocation: {registeredWatchers: null}}})).toBeNull();
                });
            });
            describe('and state registered watcher is undefined', () =>{
                it('should return undefined', () =>{
                    expect(selectors.registeredWatchersSelector(<any>{app:{geoLocation: {registeredWatchers: undefined}}})).toBeUndefined();
                });
            });
            describe('and state registered watchers is set', () =>{
                it('should return state last known position', () =>{
                    let watchers = {watcher1: 'watcher1'};
                    expect(selectors.registeredWatchersSelector(<any>{app: {geoLocation: {registeredWatchers: watchers}}})).toBe(watchers);
                    let otherWatchers = {watcher2: 'my-watcher', watcher3: 'another watcher'};
                    expect(selectors.registeredWatchersSelector(<any>{app: {geoLocation: {registeredWatchers: otherWatchers}}})).toBe(otherWatchers);
                });
            });
        });
    })
