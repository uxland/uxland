...
export {reducer as initializedReducer, appInitializedSelector, setAppInitialized} from './initialized';
export {reducer as onlineReducer, init as onlineInit, onlineSelector} from './online';
export {reducer as orientationReducer, init as orientationInit, orientationSelector} from './orientation';