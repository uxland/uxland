...
describe('Date serializer', () => {
  ...
  describe('SAPDateSerializer', () => {
    it('given a timestamp in "yyyymmddTHHmmss" format, it must return a date', () => {
      ...
      expect(SAPDateSerializer(timestamp)).to.deep.equal(
