...
export const displayMetaInformation = (): void => {
  ...
  console.log(
    `%c|-- Browser language: ${window.navigator.language}`,
    "color:#388e3c"
  );
  console.log(
    `%c|-- System Platform: ${window.navigator.platform}`,
    "color:#388e3c"
  );
  console.log(
    `%c|-- User Agent: ${window.navigator.userAgent}`,
    "color:#388e3c"
  );
  console.log(
    `%c|-- Cookies enabled: ${window.navigator.cookieEnabled}`,
    "color:#388e3c"
  );
  ...
  console.log(
    `%c|-- Lit-html version: ${(window as any).litHtmlVersions[0]}`,
    "color:#388e3c"
  );
  console.log(
    `%c|-- Browser bar visible: ${window.locationbar.visible}`,
    "color:#388e3c"
  );
  console.log(
    `%c|-- Orientation: ${
  ...
  console.log(
    `%c|-- Pixel depth: ${window.screen.pixelDepth}`,
    "color:#388e3c"
  );
  console.log("");
};
